<?php 
    ...
    $query = mysqli_query($connection, "SELECT * FROM hstry_data_tagihan JOIN jenispembayaran ON (jenispembayaran.idPembayaran = hstry_data_tagihan.idPembayaran) WHERE idUser = '$idUser'");
