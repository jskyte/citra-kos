...
if (isset($_POST['submit'])) {
    ...
    mysqli_query($connection, "UPDATE d_masterkamarcpy SET Nama = '$nama', Tgl_Kui = '$tglKejadian' WHERE No_Kamar = '$getNoKamar'");

    mysqli_query($connection, "INSERT INTO c_laporanklrmsk VALUES('', '$getNoKamar', '$nama', '$harga', '$idPembayaran', '$tglKejadian', '$categoryTempat', NOW(), '$idUser', 'MASUK', '')");

    mysqli_query($connection, "INSERT INTO e_loguser VALUES('', '$getNoKamar', '$nama', '$harga', '$idPembayaran', '$tglKejadian', '$categoryTempat', NOW(), '$idUser', 'MASUK', '')");
