...
$query = mysqli_query($connection, "SELECT * FROM b_data_print_kuitansi JOIN jenispembayaran ON (jenispembayaran.idPembayaran = b_data_print_kuitansi.idPembayaran) ORDER BY b_data_print_kuitansi.No_Kamar");
